...
class Job extends Model {
	...
	public function financial_credit_card()
    {
        return $this->hasMany('App\Http\Models\Financial', 'user_id','user_id')->where('person_name','!=','');
    }
	
	public function user_money()
    {
        return $this->hasOne('App\Http\Models\Money', 'user_id','user_id')->orderBy('id','desc');
    }
    ...
    {
        return $this->hasOne('App\Http\Models\Contract')->orderBy('id','desc');
    }
    ...
    {
        return $this->hasOne('App\Http\Models\Proposal', 'job_id','id')->where('offer',1)->orderBy('id','desc');
    }
