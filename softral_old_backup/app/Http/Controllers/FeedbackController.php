...
class FeedbackController extends Controller {
	...
	*/
	...
	public function freelancerFeedback()
	{
		...
		$feedback=Feedback::where('contract_id',$contract['id'])->where('freelancer_id',$contract['proposal']['user_id'])->where('employee_id',$contract['job']['user_id'])->where('employee_comment','!=','')->first();
