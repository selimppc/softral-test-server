<div class="container-fluid no-padding no-margin">
    <section class="regular slider">
        <div class="relative">
            <img src="{{URL::to('')}}/assets/images/banner/ban-0.jpg" class="img-responsive">
        ...
        <div class="relative">
            <img src="{{URL::to('')}}/assets/images/banner/ban-01.jpg" class="img-responsive">
            <div class="caption text-center">
        ...
        <div class="relative">
            <img src="{{URL::to('')}}/assets/images/banner/ban-02.jpg" class="img-responsive">
            <div class="caption text-center">
        ...
        <div class="relative">
            <img src="{{URL::to('')}}/assets/images/banner/ban-03.jpg" class="img-responsive">
            <div class="caption text-center">
