@include('laravel-authentication-acl::client.layout.master_layout')
 ...
 <article class="bg_gray_super_light">
	...
	<section class="wrap">
        <div class="container-fluid home-hexa-video-wrapper">
            <!-- Left Content-->
            <div class="col-md-7 hexa-wrapper">
            ...
            <div class="col-md-5 video-wrapper">
                <div class="row">
                    <div class="col-md-12 relative video-scroller">
