                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('custom_profile_1', array('Buyer'=>'Employer','Seller'=>'Freelancer'),$user_profile->profile_field_type->value, ['class' => 'form-control', 'placeholder' => '']) !!}
                        </div>
						...
						@if($profile_data->id!='2' && $profile_data->id!='3' && $profile_data->id!='1' && $profile_data->id!='6' && $profile_data->id!='7' && $profile_data->id!='8' )
                        <div class="form-group">
