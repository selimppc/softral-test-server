          ...
          <div class="col-md-12">
              ...
              <table class="table table-hover">
                      ...
                      <tbody>
                          ...
                          <tr>
							  <td>@if($user->value=='Seller') Freelancer @elseif($user->value=='Buyer') Employer @else Both @endif</td>
                              <td>{!! $user->email !!}</td>
                              ...
                              <td>
                                  @if(! $user->protected)
                                      <a href="{!! URL::route('users.profile.edit', ['user_id' => $user->id]) !!}" title='Edit profile'><i class="fa fa-pencil-square-o fa-2x"></i></a>
                                      <a href="{!! URL::route('users.selfabout.edit', ['user_id' => $user->id]) !!}" title='Edit About info'><i class="fa fa-book fa-2x"></i></a>
