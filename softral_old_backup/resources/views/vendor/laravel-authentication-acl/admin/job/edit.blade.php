       ...
       @if($errors->any())
		...
		@endif
                ...
                <div class="col-md-6 col-xs-12">
                 @if(isset($job->id))
					{!! Form::model($job,['route'=>'job.adminedit','class' => 'form', 'method' => 'post','files'=>true]) !!}
				 @else
					{!! Form::model($job,['route'=>'job.Jobadminsave','class' => 'form', 'method' => 'post','files'=>true]) !!}
				 @endif
			...
			<div class="form-group" style='width:737px'>
				...
				{!! Form::file('images[]', array('multiple'=>true)) !!}
					...
					{!! Form::select('status',['1'=>'Active','0'=>'Inactive'],null, ['class' => 'form-control','style'=>'width:45%;display:inline'] ); !!}
