	...
	<ol class="breadcrumb">
            ...
            <div class="col-md-12">
              <div class="panel panel-default">
				...
				{!! Form::model($proposal,['route'=>'job.adminsaveProposal','class' => 'form', 'method' => 'post']) !!}
				{!! isset($proposal->id)?Form::hidden('id'):'' !!}	
				 ...
				 <div class="form-group">
					...
					{!! Form::select('status',['1'=>'Active','0'=>'Suspend'],null, ['class' => 'form-control','style'=>'width:15%;display:inline'] ); !!}
				...
				$input1=json_decode($proposal['amount']);
				//dd($input1);
				
				
				//dd(amount[hoursperweek]);exit();
				?>	
					 
					 <div class="col-md-3">Hours(Optional)<input type="number" min="1" max="10000"  class="form-control decrease_size" name="amount[hoursperweek]" id="hoursperweek" placeholder="Hours/Week" value="{!! $input1->hoursperweek!!}" ><span>/Week</span></div>
					 
                      <div class="col-md-3">Duration(Optional)<input type="number" min="1" max="10000"  class="form-control decrease_size" name="amount[duration]" id="duration" placeholder="Total Duration" value="{!! $input1->duration!!}" ><span>Weeks</span></div>
                    </div>
					<br/><br/><br/>
					 <div class="form-group">
