       ...
       @if($errors->any())
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="panel-title bariol-thin"><i class="fa fa-user"></i> Add Skrill Account</h3>
                    </div>
                </div>
            </div>
            <div class="panel-body">
                <div class="row">
					...
					{!! Form::open(array('route' => 'account.save', 'class' => 'form','method' => 'POST')) !!}
				
				<div class="form-group">
					<div class='row'>
					<div class='col-md-6'>
					{!! Form::label('Skrill account', 'Skrill ID: *', ['class' => 'control-label','style'=>'display:block']) !!}
					{!! Form::text('skrill_account', NULL, ['class' => 'form-control','placeholder'=>'Skrill username','style'=>'width:90%;display:inline']) !!} 
					</div>
					</div>
				</div>
