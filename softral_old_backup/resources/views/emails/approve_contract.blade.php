...
<tr style="line-height:0">
<td style="line-height:0;background-color:#ffffff" width="425" height="83" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:25px;color:#333333;margin:0;padding:0;line-height:45px;font-weight:bold;margin-left:90px;margin-bottom:0"><br/>Approve Request for Job</p>
</td>
</tr>
...
<td style="line-height:0;background-color:#ffffff" width="548" height="37" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#333333;margin:0;padding:0;line-height:14px;font-weight:bold;margin-bottom:0">Hi Admin,You have got Approve request of Contract for Job <a href="{{ URL::to('job') }}/{!! $proposal['job']['slug'] !!}">{!! $proposal['job']['project_name'] !!}</a>.</p></td>
...
<tr style="line-height:0">
<td style="line-height:0;background-color:#ffffff" width="28" height="30" bgcolor="#ffffff" valign="top"></td>
<td style="line-height:0;background-color:#ffffff" width="548" height="30" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:12px;color:#333333;margin:0;padding:0;line-height:20px;font-weight:normal;margin-bottom:0">Approve Contract by clicking here <a href="{{ URL::to('admin/contracts/list') }}">Approve Contract</a></p></td>
<td style="line-height:0;background-color:#ffffff" width="24" height="30" bgcolor="#ffffff" valign="top"></td>
</tr>
