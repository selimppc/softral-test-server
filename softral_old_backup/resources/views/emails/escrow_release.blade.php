...
<tr style="line-height:0">
<td style="line-height:0;background-color:#ffffff" width="425" height="83" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:25px;color:#333333;margin:0;padding:0;line-height:45px;font-weight:bold;margin-left:90px;margin-bottom:0"><br/>Employee Payment Notification</p>
</td>
</tr>
...
<td style="line-height:0;background-color:#ffffff" width="548" height="37" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#333333;margin:0;padding:0;line-height:14px;font-weight:bold;margin-bottom:0">Employee has released money to the freelancer.</p></td>
...
<td style="line-height:0;background-color:#ffffff" width="548" height="30" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:12px;color:#333333;margin:0;padding:0;line-height:20px;font-weight:normal;margin-bottom:0">Payment Details:</p></td>
...
<tr style="line-height:0">
<td style="line-height:0;background-color:#ffffff" width="28" height="20" bgcolor="#ffffff" valign="top"></td>
<td style="line-height:0;background-color:#ffffff" width="548" height="20" bgcolor="#ffffff" valign="top"><strong>Job Name: </strong>{!! $freelancer['job']['project_name'] !!}</td>
<td style="line-height:0;background-color:#ffffff" width="24" height="20" bgcolor="#ffffff" valign="top"></td>
</tr>
<tr style="line-height:0">
<td style="line-height:0;background-color:#ffffff" width="28" height="20" bgcolor="#ffffff" valign="top"></td>
<td style="line-height:0;background-color:#ffffff" width="548" height="20" bgcolor="#ffffff" valign="top"><strong>Employer name: </strong>{!! $employee['user_profile'][0]['first_name'] !!}</td>
<td style="line-height:0;background-color:#ffffff" width="24" height="20" bgcolor="#ffffff" valign="top"></td>
</tr>
<tr style="line-height:0">
<td style="line-height:0;background-color:#ffffff" width="28" height="20" bgcolor="#ffffff" valign="top"></td>
<td style="line-height:0;background-color:#ffffff" width="548" height="20" bgcolor="#ffffff" valign="top"><strong>Freelancer name: </strong>{{$freelancer['proposal']['user']['user_profile'][0]['first_name']}}</td>
<td style="line-height:0;background-color:#ffffff" width="24" height="20" bgcolor="#ffffff" valign="top"></td>
</tr>
<tr style="line-height:0">
<td style="line-height:0;background-color:#ffffff" width="28" height="20" bgcolor="#ffffff" valign="top"></td>
<td width="548" height="20" bgcolor="#ffffff" valign="top" style='line-height:18px;padding-bottom: 10px;background-color:#ffffff'><strong>Released amount:</strong> ${!! $amount !!}</td>
<td style="line-height:0;background-color:#ffffff" width="24" height="20" bgcolor="#ffffff" valign="top"></td>
</tr>
...
<td style="line-height:0;background-color:#ffffff" width="548" height="29" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:12px;color:#333333;margin:0;padding:0;line-height:12px;font-weight:normal;margin-bottom:0">You can check the contract <a href="{!! URL::to('/') !!}/financial/terms_milestone?p_id={!! $freelancer['proposal']['id'] !!}">{!! $freelancer['job']['project_name'] !!}</a></p></td>
