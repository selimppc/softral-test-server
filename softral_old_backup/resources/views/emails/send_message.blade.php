...
<td style="line-height:0;background-color:#ffffff" width="548" height="37" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#333333;margin:0;padding:0;line-height:14px;font-weight:bold;margin-bottom:0">Hi {!!$data['user_profile'][0]['first_name']!!},</p></td>
...
<td style="line-height:0;background-color:#ffffff" width="548" height="30" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:12px;color:#333333;margin:0;padding:0;line-height:20px;font-weight:normal;margin-bottom:0">{!! $logged_in['user_profile'][0]['first_name'] !!} is interested in talking to you. Please go to <a href="{!! URL::to('/') !!}/chat/index.php?invite_id={{$logged_in['id']}}">Softral Chat</a> to see the message</p></td>
<td style="line-height:0;background-color:#ffffff" width="24" height="30" bgcolor="#ffffff" valign="top"></td>
</tr>

<tr style="line-height:0">
<td style="line-height:0;background-color:#ffffff" width="28" height="30" bgcolor="#ffffff" valign="top"></td>
<td style="line-height:0;background-color:#ffffff" width="548" height="30" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:12px;color:#333333;margin:0;padding:0;line-height:20px;font-weight:normal;margin-bottom:0">Pleaes click on this link : <a href="{!! URL::to('/') !!}/chat/index.php?invite_id={{$logged_in['id']}}">Chat to {{$logged_in['user_profile'][0]['first_name']}}</a></p></td>
<td style="line-height:0;background-color:#ffffff" width="24" height="30" bgcolor="#ffffff" valign="top"></td>
</tr>
</tbody></table>
</tbody></table><table cellpadding="0" cellspacing="0" width="600" style="line-height:0">
