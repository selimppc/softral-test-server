...
<tr style="line-height:0">
<td style="line-height:0;background-color:#ffffff" width="425" height="83" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:25px;color:#333333;margin:0;padding:0;line-height:45px;font-weight:bold;margin-left:90px;margin-bottom:0"><br/>Escrow Money Notification</p>
</td>
</tr>
...
<td style="line-height:0;background-color:#ffffff" width="548" height="37" bgcolor="#ffffff" valign="top"><p style="font-family:Helvetica,Arial,sans-serif;font-size:14px;color:#333333;margin:0;padding:0;line-height:16px;font-weight:bold;margin-bottom:20px">Hi {!! $proposal['job']['user']['user_profile'][0]['first_name'] !!}, Thank you for funding escrow account for job <a href="{{ URL::to('job') }}/{!! $proposal['job']['slug'] !!}">{!! $proposal['job']['project_name'] !!}</a> The transfer of funds may take 1-3 business days depending upon mode of payment. We will notify your freelancer that he/she may begin work. </p></td>
...
<tr style="line-height:0">
<td style="line-height:0;background-color:#ffffff" width="28" height="20" bgcolor="#ffffff" valign="top"></td>
<td style="line-height:0;background-color:#ffffff" width="548" height="20" bgcolor="#ffffff" valign="top"><strong>Funded Amount: </strong>${!! $amount!!}</td>
<td style="line-height:0;background-color:#ffffff" width="24" height="20" bgcolor="#ffffff" valign="top"></td>
</tr>
<br/>
