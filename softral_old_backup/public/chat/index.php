...
$select1 = $dbh->prepare("select * from users where id=" . $_SESSION['id'] . "");
...
<!--                        <span style="
    ...
    <div class="container">
        ...
        <div class="alert alert-success">You have successfully sent a message to freelancer</div>
      <?php endif; ?>
...
//            $(".chatbox").css("width", "100%");
    ...
    function mobileViewUpdateResize() {
        var viewportWidth = $(document).width();
    ...
    $(window).resize(mobileViewUpdateResize);
    
    
</script>

<style>
    .back-chat-left-panel:hover{
        cursor: pointer;
    }
</style>
</body>
