...
//                            where a.sender_id in('" . $_SESSION['id'] . "', '$sendto') and a.reciever_id in('" . $_SESSION['id'] . "', '$sendto')");
     ...
     * 
     * But commented on 31/08/2016
     * to make the conversation faster
     */
...
//                            ORDER BY id DESC LIMIT 20) sub ORDER BY id ASC");
    ...
    while ($r = $sql->fetch()) {
        ...
        if ($r['sender_id'] == $_SESSION['id']) {
            ...
            //$friend_profile_pic = '<img class="thumb-prof-pic" width="35px" height="35px" src="' . $websiteRoot . '/images/mycroppic.jpg" style="margin-right:5px; float:left;">';
